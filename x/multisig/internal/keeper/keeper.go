...
func NewKeeper(cdc *codec.Codec, key sdk.StoreKey, paramspace types.ParamSubspace, accountKeeper auth.AccountKeeper, bankKeeper bank.Keeper, coinKeeper coin.Keeper) Keeper {
	keeper := Keeper{
		storeKey:      key,
		cdc:           cdc,
