...
import (
	"bitbucket.org/decimalteam/go-node/x/multisig/types"
	"encoding/json"
...
func (am AppModule) InitGenesis(_ sdk.Context, cdc codec.JSONMarshaler, data json.RawMessage) []abci.ValidatorUpdate {
