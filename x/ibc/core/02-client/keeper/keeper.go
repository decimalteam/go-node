...
type Keeper struct {
	...
	validatorKeeper types2.ValidatorKeeper
}

// NewKeeper creates a new NewKeeper instance
func NewKeeper(cdc codec.BinaryMarshaler, key sdk.StoreKey, paramSpace paramtypes.Subspace, validatorKeeper types2.ValidatorKeeper) Keeper {
...
func (k Keeper) GetSelfConsensusState(ctx sdk.Context, height exported.Height) (exported.ConsensusState, bool) {
	...
	histInfo, found := k.validatorKeeper.GetHistoricalInfo(ctx, int64(selfHeight.RevisionHeight))
	if !found {
		return nil, false
	}
...
func (k Keeper) ValidateSelfClient(ctx sdk.Context, clientState exported.ClientState) error {
	...
	expectedUbdPeriod := k.validatorKeeper.UnbondingTime(ctx)
