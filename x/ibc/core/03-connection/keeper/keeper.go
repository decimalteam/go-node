...
import (
	types2 "bitbucket.org/decimalteam/go-node/x/ibc/core/03-connection/types"
...
func NewKeeper(cdc codec.BinaryMarshaler, key sdk.StoreKey, ck types2.ClientKeeper) Keeper {
	return Keeper{
		storeKey:     key,
		cdc:          cdc,
		clientKeeper: ck,
