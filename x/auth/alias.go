...
// ALIASGEN: bitbucket.org/decimalteam/go-node/x/auth/ante
// ALIASGEN: bitbucket.org/decimalteam/go-node/x/auth/keeper
// ALIASGEN: bitbucket.org/decimalteam/go-node/x/auth/types
package auth
