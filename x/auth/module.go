...
import (
	...
	"bitbucket.org/decimalteam/go-node/x/auth/client/cli"
	"bitbucket.org/decimalteam/go-node/x/auth/client/rest"
	"bitbucket.org/decimalteam/go-node/x/auth/simulation"
