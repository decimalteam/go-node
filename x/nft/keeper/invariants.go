...
func SupplyInvariant(k Keeper) sdk.Invariant {
	return func(ctx sdk.Context) (string, bool) {
		...
		k.IterateCollections(ctx, func(collection types2.Collection) bool {
		...
		return sdk.FormatInvariant(types2.ModuleName, "supply", fmt.Sprintf(
