...
func TestProposalPassedEndBlocker(t *testing.T) {
	...
	proposal, err := input.keeper.SubmitProposal(ctx, keep.TestProposal.Content, updates.Update2Block+keep.TestProposal.VotingStartBlock, updates.Update2Block+keep.TestProposal.VotingEndBlock)
	require.NoError(t, err)
