...
//	ctx, keeper, accountKeeper := keeper2.CreateTestInput(t, false)
//
//	coin := createCoin(ctx, keeper)
//
//	initBalance := helpers.BipToPip(sdk.NewInt(1000000))
//
//	account := accountKeeper.NewAccountWithAddress(ctx, keeper2.Addrs[0])
...
//	require.True(t, ok)
//
//	buyCoinMsg := NewMsgBuyCoin(keeper2.Addrs[0], sdk.NewCoin(coin.Symbol, toBuy), sdk.NewCoin(cliUtils.GetBaseCoin(), maxValToSell))
...
//	require.True(t, ok)
//
//	account = accountKeeper.GetAccount(ctx, keeper2.Addrs[0])
...
//	buyCoinMsg := NewMsgBuyCoin(keeper2.Addrs[0], sdk.NewCoin(coin.Symbol, toBuy), sdk.NewCoin(cliUtils.GetBaseCoin(), maxValToSell))
//	_, err = handleMsgBuyCoin(ctx, keeper, buyCoinMsg)
//	require.EqualError(t, err, types2.ErrInsufficientFunds("100045012002100252021", "1000000000000000000").Error())
//}
//
...
//	require.True(t, ok)
//
//	buyCoinMsg := NewMsgBuyCoin(keeper2.Addrs[0], sdk.NewCoin(coin.Symbol, toBuy), sdk.NewCoin(coin.Symbol, maxValToSell))
//	err = buyCoinMsg.ValidateBasic()
//	require.EqualError(t, err, types2.ErrSameCoin().Error())
//}
//
...
//	require.True(t, ok)
//
//	buyCoinMsg := NewMsgBuyCoin(keeper2.Addrs[0], sdk.NewCoin("invalid", toBuy), sdk.NewCoin(coin.Symbol, maxValToSell))
//	_, err = handleMsgBuyCoin(ctx, keeper, buyCoinMsg)
//	require.EqualError(t, err, types2.ErrCoinDoesNotExist("invalid").Error())
//}
//
...
//	require.True(t, ok)
//
//	buyCoinMsg := NewMsgBuyCoin(keeper2.Addrs[0], sdk.NewCoin(coin.Symbol, toBuy), sdk.NewCoin("invalid", maxValToSell))
//	_, err = handleMsgBuyCoin(ctx, keeper, buyCoinMsg)
//	require.EqualError(t, err, types2.ErrCoinDoesNotExist("invalid").Error())
//}
//
...
//	require.True(t, ok)
//
//	buyCoinMsg := NewMsgBuyCoin(keeper2.Addrs[0], sdk.NewCoin(cliUtils.GetBaseCoin(), toBuy), sdk.NewCoin(coin.Symbol, maxValToSell))
//	_, err = handleMsgBuyCoin(ctx, keeper, buyCoinMsg)
//	require.NoError(t, err)
//
...
//	buyCoinMsg := NewMsgBuyCoin(keeper2.Addrs[0], sdk.NewCoin(cliUtils.GetBaseCoin(), toBuy), sdk.NewCoin(coin.Symbol, maxValToSell))
//	_, err = handleMsgBuyCoin(ctx, keeper, buyCoinMsg)
//	require.EqualError(t, err, types2.ErrTxBreaksMinReserveRule(ctx, toBuy.String()).Error())
//}
//
...
//	require.True(t, ok)
//
//	sellCoinMsg := NewMsgSellCoin(keeper2.Addrs[0], sdk.NewCoin(cliUtils.GetBaseCoin(), valueToSell), sdk.NewCoin(coin.Symbol, minValToBuy))
...
//	require.True(t, ok)
//
//	sellCoinMsg := types2.NewMsgSellCoin(keeper2.Addrs[0], sdk.NewCoin(cliUtils.GetBaseCoin(), sdk.ZeroInt()), sdk.NewCoin(coin.Symbol, minValToBuy))
...
//	symbol := "ABCDEF"
//
//	sellCoinMsg := types2.NewMsgCreateCoin(keeper2.Addrs[0], title, symbol, crr, volume, reserve, volume.MulRaw(10), "")
