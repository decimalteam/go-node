...
func NewDeductFeeDecorator(ak keeper.AccountKeeper, sk authtypes.SupplyKeeper) DeductFeeDecorator {
...
func DeductFees(supplyKeeper authtypes.SupplyKeeper, ctx sdk.Context, acc exported.Account, fees sdk.Coins) error {
