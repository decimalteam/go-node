...
// broadcasted.
func GenerateOrBroadcastMsgs(cliCtx context.CLIContext, txBldr types.TxBuilder, msgs []sdk.Msg) error {
...
func CompleteAndBroadcastTxCLI(txBldr types.TxBuilder, cliCtx context.CLIContext, msgs []sdk.Msg) error {
...
func EnrichWithGas(txBldr types.TxBuilder, cliCtx context.CLIContext, msgs []sdk.Msg) (types.TxBuilder, error) {
...
func PrintUnsignedStdTx(txBldr types.TxBuilder, cliCtx context.CLIContext, msgs []sdk.Msg) error {
...
func SignStdTx(
	txBldr types.TxBuilder, cliCtx context.CLIContext, name string,
...
func SignStdTxWithSignerAddress(txBldr types.TxBuilder, cliCtx context.CLIContext,
	addr sdk.AccAddress, name string, stdTx types.StdTx,
	offline bool) (signedStdTx types.StdTx, err error) {
...
func ReadStdTxFromFile(cdc *codec.Codec, filename string) (stdTx types.StdTx, err error) {
	var bytes []byte
...
func simulateMsgs(txBldr types.TxBuilder, cliCtx context.CLIContext, msgs []sdk.Msg) (estimated, adjusted uint64, err error) {
...
func PrepareTxBuilder(txBldr types.TxBuilder, cliCtx context.CLIContext) (types.TxBuilder, error) {
...
func buildUnsignedStdTxOffline(txBldr types.TxBuilder, cliCtx context.CLIContext, msgs []sdk.Msg) (stdTx types.StdTx, err error) {
	...
	return types.NewStdTx(stdSignMsg.Msgs, stdSignMsg.Fee, stdSignMsg.FeeCoin, nil, stdSignMsg.Memo), nil
}
