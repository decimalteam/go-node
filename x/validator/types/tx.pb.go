...
type MsgDeclareCandidate struct {
	...
	ValidatorAddr string                                  `protobuf:"bytes,2,opt,name=validator_addr,json=validatorAddr,proto3" json:"validator_addr" yaml:"validator_addr"`
	RewardAddr    string                                  `protobuf:"bytes,3,opt,name=reward_addr,json=rewardAddr,proto3" json:"reward_addr" yaml:"reward_addr"`
	...
	PubKey        *types.Any                              `protobuf:"bytes,6,opt,name=pub_key,json=pubKey,proto3" json:"pub_key" yaml:"pub_key"`
}
...
type MsgDelegateNFT struct {
	DelegatorAddress string                                 `protobuf:"bytes,1,opt,name=delegator_address,json=delegatorAddress,proto3" json:"delegator_address" yaml:"delegator_address"`
	ValidatorAddress string                                 `protobuf:"bytes,2,opt,name=validator_address,json=validatorAddress,proto3" json:"validator_address" yaml:"validator_address"`
	Token_ID         string                                 `protobuf:"bytes,3,opt,name=token_ID,json=tokenID,proto3" json:"token_id" yaml:"token_id"`
...
var fileDescriptor_3d1df81e3a65fd6a = []byte{
	...
	,
}
...
func (m *MsgDelegateNFT) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Token_ID) > 0 {
		i -= len(m.Token_ID)
		copy(dAtA[i:], m.Token_ID)
		i = encodeVarintTx(dAtA, i, uint64(len(m.Token_ID)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.ValidatorAddress) > 0 {
...
func (m *MsgDelegateNFT) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Token_ID", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Token_ID = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
